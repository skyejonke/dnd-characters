...
\AddWeapon{Dart (range 20/60)}{+5}{1d4 +5 p}
...
\PersonalityTraits{
  \begin{itemize}
    ...
    \item She gets fixated on particular organisms for short periods and will do
          as much as she can to find out more about them, before her attention
          is pulled elsewhere.
...
\FirstLevelSpellSlotA{Stuff }
\FirstLevelSpellSlotB{Stuff}
